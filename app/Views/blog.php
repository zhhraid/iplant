...
<body>
    ...
    <main class="container blog-main">
        <div class="blog-grid">
            ...
            <div class="blog-card">
                <div class="blog-image">
                    <a href="/blog-detail?id=<?= esc($slug) ?>"><img src="<?= esc($post['image']) ?>" alt="<?= esc($post['title']) ?>" onerror="this.src='https://placehold.co/400x250?text=iplant.id'"></a>
                </div>
                <div class="blog-info">
                    <h3 class="blog-title"><a href="/blog-detail?id=<?= esc($slug) ?>"><?= esc($post['title']) ?></a></h3>
        ...
        <div class="blog-actions" style="display: none;">
            <button class="btn-load-more">Perlihatkan Lagi</button>
        </div>
    </main>
